...
# # """
user_proxy.initiate_chat(group_chat_manager, message="First Search and Scrap the content the search and have the detailed about from about e-vehicles done only once and have a discussion on it")